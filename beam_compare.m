function [] = beam_compare(varargin)
%------------------------------------------------------------------------------------------------
...
%-----------------compare diameters----------------------------------------
[max_value,max_index] = sort(blobECD,'descend');
fprintf('no %d diameter = %d\n',max_index(1),max_value(1))
fprintf('no %d diameter = %d\n',max_index(2),max_value(2))
fprintf('no %d has a larger diameter than no %d\n',max_index(1),max_index(2))
%--------------------------------------------------------------------------
if verbose
